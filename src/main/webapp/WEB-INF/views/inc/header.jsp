...
.gnb ul.header-menu>li {
	float: left;
}

.gnb ul.header-menu li a {
	display: block;
	width: 150px;
	padding: 0 5px;
	text-align: center;
...
.gnb ul.header-menu ul.submenu {
	display: none;
}

.gnb ul.header-menu li:hover ul.submenu {
	display: block;
	background-color: #ffd2d9;
	opacity: 0.7;
}

.gnb ul.header-menu li:hover a {
	font-weight: bold;
}
...
.gnb ul.header-menu .menuhover :hover {
	color: #ff0080;
}
...
<header id="header">
   <div class="content-container">
      <h1 id="logo">
         <a href="../home/main"><img src="../../../resource/images/logo.png"
